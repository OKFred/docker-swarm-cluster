  ...
  <div>
    ...
    <a-card>
      ...
      <a-row>
        ...
        <a-col :span="6">Loadavg: {{ localObj.data.systemInfo.loadavg }}</a-col>
        <a-col :span="6"
          >Totalmem: {{ localObj.data.systemInfo.totalmem }}</a-col
        >
      </a-row>
      <a-row>
        <a-col :span="6">Freemem: {{ localObj.data.systemInfo.freemem }}</a-col>
        <a-col :span="6"
          >Hostname: {{ localObj.data.systemInfo.hostname }}</a-col
        >
        <a-col :span="6">Type: {{ localObj.data.systemInfo.type }}</a-col>
        <a-col :span="6">Release: {{ localObj.data.systemInfo.release }}</a-col>
      </a-row>
    </a-card>
    <br />
